/************************** monte.c *******************************/
/* Kennedy-Pendleton quasi heat bath for SU(2) */
/* MIMD version 3 */
/* T. DeGrand March 1991 */
/* J. Hetrick and D. Toussaint April 1995 */
/* U.M. Heller July 1996 */
...
*/
/* generate an su(2) matrix h according to exp(bg/2 * re tr(h*s))
   ...
   rewrite beta/2 * re tr(h*v) * z as al*a0
